...
import LessonContent5 from './LessonContent5';
import TalkMeNowActivity5 from './TalkMeNowActivity5';
...
function App() {
  ...
  useEffect(() => {
    setAudioSrc(`${process.env.PUBLIC_URL}/audio5/Lesson5/${audioFiles[currentAudioIndex]}`);
  ...
  return (
    <div className="app">
      ...
      {currentView === 'lesson' ? (
        <>
          <LessonContent5 currentLessonIndex={currentAudioIndex} isPlaying={isPlaying} />
